...
locals {
  lambda_root = "../../code/HelloWorldLambda/"
  zipfile_name = "helloworldlambda.zip"
  bucket_name = "sample-s3-bucket-lambda-artifacts"
}
...
resource "null_resource" "install_dependencies" {
  ...
  triggers = {
    ...
    source_versions = filemd5("${local.lambda_root}/app.py")
  }
}
